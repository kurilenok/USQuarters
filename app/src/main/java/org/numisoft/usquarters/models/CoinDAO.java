...
public class CoinDao {
    ...
    private Map<String, Coin> getChildren(SQLiteDatabase db, Coin coin) {
        Map<String, Coin> children = new HashMap<>();

        String childPId = coin.getCoinId().substring(0, coin.getCoinId().length() - 1) + "7";
        String childDId = coin.getCoinId().substring(0, coin.getCoinId().length() - 1) + "5";
